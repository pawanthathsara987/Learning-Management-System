<?php
    ...
    $sql = "SELECT 
            ...
            FROM
                course sc
            INNER JOIN
                stu_course scs ON scs.cour_code = sc.cour_code
            INNER JOIN
                student s ON s.stu_id = scs.stu_id
            WHERE
                s.user_id = '$uid'";
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <form action="Enroll_btn.php" method="POST">
                                                    ...
                                                    <button class="btn btn-primary w-50 enroll-button">
                                                        <span>Enroll</span>
                                                    </button>
                                                </form>
